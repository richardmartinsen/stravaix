...
namespace Stravaix.StravaApi.Authentication
{
    using System;
    ...
    //using global::StravaApi.Authentication;
    ...
    public class LocalWebServer
    {
        ...
        {
            this._context = this._httpListener.GetContext();
            NameValueCollection queries = this._context.Request.QueryString;
            ...
            this._context.Response.ContentLength64 = b.Length;
            this._context.Response.OutputStream.Write(b, 0, b.Length);
            this._context.Response.OutputStream.Close();


            // Getting the Access Token
            String url = String.Format("https://www.strava.com/oauth/token?client_id={0}&client_secret={1}&code={2}", this.ClientId, this.ClientSecret, code);
