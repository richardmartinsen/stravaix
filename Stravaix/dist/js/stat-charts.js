$(function(){
    function pageLoad() {
        //var testData = window.testData(['Score'],
        ...
        //     */
        //    var test = $.getJSON("/Home/GetJsonResult", null, function (data) {
        //        console.log("data : ", data);
        //        $.each(data, function (index, x) {
        //            console.log("index : ", index);
        //            console.log("x : ", x);
        //            console.log("score : ", x.Score);
        //            testData[index] = x.Score;
        ...
        //    $.getJSON("/Home/GetJsonResult", null, function (data) {
        //        console.log("data : ", data);
        //        $.each(data, function (index, x) {
        //            console.log("index : ", index);
        //            console.log("x : ", x);
        //            console.log("score : ", x.Score);
        //            lineData[index] = x.Score;
